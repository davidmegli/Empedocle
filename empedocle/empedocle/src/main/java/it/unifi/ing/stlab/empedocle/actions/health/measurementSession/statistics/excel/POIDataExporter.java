package it.unifi.ing.stlab.empedocle.actions.health.measurementSession.statistics.excel;
...
//			MeasurementSessionType measurementSessionType = ClassHelper.cast(rootFact.getContext(), MeasurementSession.class).getType();
