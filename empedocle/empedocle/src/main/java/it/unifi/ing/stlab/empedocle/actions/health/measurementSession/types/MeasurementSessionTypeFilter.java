...
import it.unifi.ing.stlab.empedocle.dao.health.MeasurementSessionTypeQueryBuilder;
...
@Named
@SessionScoped
public class MeasurementSessionTypeFilter extends FilterBean implements MeasurementSessionTypeQueryBuilder {
	...
	public MeasurementSessionTypeFilter() {
		setPageSize( 10 );
	...
	public Query getCountQuery( EntityManager entityManager ) {
		...
		buffer.append( "select count( distinct et ) from MeasurementSessionType et" );
		writeFilters( buffer );
	...
	public Query getListQuery( EntityManager entityManager ) {
		...
		buffer.append( "select distinct et from MeasurementSessionType et" );
