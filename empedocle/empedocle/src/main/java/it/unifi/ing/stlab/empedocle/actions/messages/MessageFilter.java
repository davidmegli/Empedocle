...
public class MessageFilter extends FilterBean implements MessageQueryBuilder { 	
	...
	public MessageFilter() {
		...
		addFilterDef( "Surname", FilterType.TEXT, "m.observableEntity.surname like :psurname", "psurname" );
		addFilterDef( "Name", FilterType.TEXT, "m.observableEntity.name like :pname", "pname" );
